...
{
    for(auto it=v.begin();it!=v.end();++it) fin>>*it; return fin;
}
...
struct Int
{
    ...
    Int operator ++(int){ Int temp = *this; *this += 1; return temp;}
    Int operator --(){ *this -= 1; return *this;}
    Int operator --(int){ Int temp = *this; *this -= 1; return temp;}
...
ll fact[MAX+7];
void fac_compute(){ fact[0]=1; fact[1]=1; rep(i,2,MAX-1) fact[i]=(fact[i-1]*i)%mod1; }
